...
def train_and_evaluate(cfg):
    ...
    logs=os.path.join('experiments',cfg.exp_type,'tboard_sup_sl_model_proxy')
    writer = SummaryWriter(logs + '/sl_model_proxy_finetune04_blur' )
...
if __name__=='__main__':
    config_file='config/config_sl_proxy.yaml'
