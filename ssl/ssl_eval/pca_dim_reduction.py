...
experiment_dir = r'/home/ivo/data/SSL/ImpRotNet_09/ssl_pytorch/experiments/self-supervised/ssl_exp_01/blur'

feature_path=os.path.join(experiment_dir,'features_blur_1')
