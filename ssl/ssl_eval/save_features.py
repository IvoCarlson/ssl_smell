...
if __name__=='__main__':
    ...
    experiment_dir = r'/home/ivo/data/SSL/ImpRotNet_09/ssl_pytorch/experiments/self-supervised/ssl_exp_01/noise'
    restore_file = 'resnet18_best.pth'
    config_file = 'config_ssl_relpos.yaml'
...
#    params = utils.Params(yaml_path)
    ...
    cfg.batch_size=1
    cfg.root_path=r'/home/ivo/data/SSL/ImpRotNet_09/ssl_pytorch/'
...
#    layer_name = model.avgpool
    ...
    features_path=os.path.join(experiment_dir,'features_blur_3')
